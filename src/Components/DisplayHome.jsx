...
import jayasudha from '../assets/jayasudha.jpeg';
  ...
  return (
    <div> 
      ...
      <div className="flex items-center mt-6 justify-between overflow-auto" ref={songContainerRef}>
        ...
        <div className='hover:bg-[#1f1f1f] p-2 rounded-md cursor-pointer hidden sm:block'>
          <img className='rounded-md w-[170px]' src="https://tse2.mm.bing.net/th/id/OIP.zWyPg0_OJkKOYqRtLCc1ewHaHa?rs=1&pid=ImgDetMain&o=7&rm=3" alt="playlist cover" />
          <p className='mt-2 text-m'><b>Paradise</b></p>
          <p className='text-sm text-[#b3b3b3]'>Cold and mild</p>
        </div>
        <div className='hover:bg-[#1f1f1f] p-2 rounded-md cursor-pointer hidden sm:block'>
          <img className=' rounded-md w-[170px]' src="https://tse4.mm.bing.net/th/id/OIP.2xCbGx220AynmwWlI2eYRQHaHa?rs=1&pid=ImgDetMain&o=7&rm=3" alt="playlist cover" />
          <p className='mt-2 text-m'><b>Boosted</b></p>
          <p className='text-sm text-[#b3b3b3]'>Best bass Boosted</p>
        </div>
      </div>

      <div className='flex  flex-col overflow-auto  hidden md:block'>
        ...
        <div className="flex mb-8  gap-4 overflow-auto ">
          <div className='hover:bg-[#1f1f1f] p-2 rounded-md cursor-pointer'>
            <img className=' rounded-full w-[250px] h-250px' src="https://tse1.mm.bing.net/th/id/OIP.vn1RnwATwfeh4EQazNt87QHaIF?rs=1&pid=ImgDetMain&o=7&rm=3" alt="artist" />
            <p className='mt-2 text-m'><b>Hip Hop Tamizha</b></p>
            <p className='text-sm text-[#b3b3b3]'>ARTIST</p>
          </div>
          <div className='hover:bg-[#1f1f1f] p-2 rounded-md cursor-pointer'>
            <img className=' rounded-full w-[250px] h-250px' src="https://1.bp.blogspot.com/-qyFqMkVTrbY/XCmM1-eqiaI/AAAAAAAABf0/d1eoDmnA4QImioFLTQQMTw0HmWFI6OHGQCLcBGAs/s1600/1.jpg" alt="artist" />
            <p className='mt-2 text-m'><b>Imagine Dragons</b></p>
            <p className='text-sm text-[#b3b3b3]'>ARTIST</p>
          </div>
          <div className='hover:bg-[#1f1f1f] p-2 rounded-md cursor-pointer'>
            <img className='rounded-full w-[250px] h-250px' src={sibi} alt="artist" />
            <p className='mt-2 text-m'><b>Sibisidharth</b></p>
            <p className='text-sm text-[#b3b3b3]'>ARTIST</p>
          </div>
          <div className='hover:bg-[#1f1f1f] p-2 rounded-md cursor-pointer'>
            <img className=' rounded-full w-[250px] h-250px' src="https://pics.craiyon.com/2023-11-16/Zbpitr_cQq-pljdPBGPw8Q.webp" alt="artist" />
            <p className='mt-2 text-m'><b>Yo Yo Honey Singh</b></p>
            <p className='text-sm text-[#b3b3b3]'>ARTIST</p>
          </div>
          <div className='hover:bg-[#1f1f1f] p-2 rounded-md cursor-pointer'>
            <img className='rounded-full w-[250px] h-250px' src={jayasudha} alt="artist" />
